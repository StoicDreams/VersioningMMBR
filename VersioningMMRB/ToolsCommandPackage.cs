...
namespace VersioningMMRB
{
	...
	public sealed class ToolsCommandPackage : AsyncPackage
	{
		/// <summary>
		/// ToolsCommandPackage GUID string.
		/// </summary>
		public const string PackageGuidString = "4ae8f7ae-8502-401c-abb0-496fdef28051";

		private DTE2 applicationObject;
		private BuildEvents buildEvents;
		/// <summary>
		/// Initializes a new instance of the <see cref="ToolsCommandPackage"/> class.
		/// </summary>
		...
		protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
		{
			...
			await ToolsCommand.InitializeAsync(this);
		...
		{
			if(Scope != vsBuildScope.vsBuildScopeProject) { return; }
			ToolsCommand.Instance.InitiateProcessorAndIncrementVersionAndCommit(Processor.VersionScope.Build);
		}
